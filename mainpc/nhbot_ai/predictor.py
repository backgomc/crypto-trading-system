...
class AIPredictor:
    ...
    def load_model(self) -> bool:
        ...
        try:
            ...
            # 모델 파일 경로
            model_path = self.models_dir / f"{active_model}.h5"
            scaler_path = self.models_dir / f"{active_model}_scaler.pkl"
            info_path = self.models_dir / f"{active_model}_info.json"
